...
//        //System.out.println(movie.length());
        HashMap<?, ?> retVal;
        parameterMap.put("sublanguageid", "ara"/*Locale.getDefault().getISO3Language()*/);
...
//                //System.out.println("Id is " + info.getIDMovieImdb());
    ...
    public List <SubtitleInfo> Search(String filePath ,String lang) throws XmlRpcException {
        computeHash(filePath);
        List <SubtitleInfo> infos=new ArrayList<>();
        Map<String, Object> parameterMap = new HashMap();
//        //System.out.println(fileHash);
//        //System.out.println(movie.length());
        HashMap<?, ?> retVal;
        parameterMap.put("sublanguageid", lang/*Locale.getDefault().getISO3Language()*/);
        parameterMap.put("moviehash", fileHash);
        String fileName = movie.getName();
        fileName = fileName.substring(0, fileName.length() - 4);
        //System.out.println(fileName);
